...
def _parse_args(argv: list[str]) -> tuple:
    ...
    return (
        ...
        since, until, generation, snapshot_prefix, commit_target, smart_target, only_reappeared, llm_summarize
    )
...
if __name__ == "__main__":
    ...
    main(
        ...
        only_reappeared=only_reappeared, llm_summarize=llm_summarize
    )
