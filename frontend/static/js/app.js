...
import "./core/appStateCtrl.js?v=0.1.436";
import "./engine/repoManager.js?v=0.1.436";
import "./engine/telemetryStream.js?v=0.1.436";
import "./engine/engineControl.js?v=0.1.436";
import "./ui/terminalView.js?v=0.1.436";

import { processCommits, filterByDateBounds } from './core/dataEngine.js?v=0.1.436';
import { renderTypesChart, renderStackChart, renderTrendChart, renderRiskCharts, renderConvergenceChart, renderTierChart } from './charts/chartCtrl.js?v=0.1.436';
import { renderHeatmap } from './ui/heatmap.js?v=0.1.436';
import { renderTable } from './ui/tableCtrl.js?v=0.1.436';
import { CM_COLORS } from './constants/colors.js?v=0.1.436';
import { UI_STATE, bumpGeneration } from './core/state.js?v=0.1.436';
import { showTotalZeroState, showFilteredZeroState, hideZeroStates } from './ui/zeroStateCtrl.js?v=0.1.436';
window.hub = hub;
window.UI_STATE = UI_STATE;
import { initGlobalTooltips } from './ui/tooltips.js?v=0.1.436';
import { initTierDistributionRevolving, initAvgSmoothingRevolving, initGlobalChronRevolving } from './ui/revolvingButton.js?v=0.1.436';
