import { CM_COLORS, BP_AXC_BASE, SC_COLORS, TYPE_COLORS } from '../constants/colors.js?v=0.1.157';
import { calcMAvg, getTop25, processCommits } from '../core/dataEngine.js?v=0.1.157';
import { UI_STATE } from '../core/state.js?v=0.1.157';
import { monthDiv, customTooltip, getXConf, MD_TOP } from './plugins.js?v=0.1.157';
...
if (!window._cmChartBindingsReady) {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (action === 'toggleGlobalChron') {
            ...
            import('../ui/heatmap.js?v=0.1.157').then(m => {
